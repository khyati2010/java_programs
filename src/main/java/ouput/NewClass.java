...
// Java program to demonstrate working of singleton()
import java.util.*;

public class NewClass {
	public static void main(String args[]) {
		String[] geekslist = { "1", "2", "4", "2", "1", "2", "3", "1", "3",
				"4", "3", "3" };

		// Creating a list and removing elements without use of
		// singleton()
		...
		System.out.println("Original geeklist2: " + geekslist2);

		// Selectively delete "1" from all it's occurences
		geekslist2.removeAll(Collections.singleton("1"));
		System.out.println("geekslist2 after removal of 1 with " + "singleton:"
				+ geekslist2);

		// Selectively delete "4" from all it's occurences
		geekslist2.removeAll(Collections.singleton("4"));
		System.out.println("geekslist2 after removal of 4 with " + "singleton:"
				+ geekslist2);

		// Selectively delete "3" from all it's occurences
